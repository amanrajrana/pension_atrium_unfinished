  ...
  return (
    <div className="flex justify-between mt-2 mb-8">
      <div className="mr-2 flex gap-4 items-center">
        <span className="text-customblue text-2xl-custom 3xl:text-3xl">{icon}</span>
        <div className="flex-col items-center">
          <p className="text-sm 3xl:text-xl font-bold">{text}</p>
          <p className="text-sm 3xl:text-xl">{subtext}</p>
        </div>
      </div>

      <div className="items-center">
        <p className="text-blue-900 font-bold text-base 3xl:text-xl">{text2}</p>
      </div>
    </div>
  );
};
