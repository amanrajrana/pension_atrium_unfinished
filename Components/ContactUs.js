  ...
  return (
    ...
    <div className="flex flex-col-reverse lg:flex-row justify-center mx-10 mb-20 items-stretch">
      ...
      <div className="flex-1  w-full lg:w-1/2 p-4 ">
        ...
        <div className="mb-4">
          <h2 className="text-2xl font-bold mb-2 text-center">Leave Us a Message</h2>
      ...
      <div className=" flex flex-col justify-center sm:flex-row gap-6 mt-12">
      <FooterColumn
          heading="Contact Info"
          row1Icon={imgAPI.home_vectors[19]}
          row1Text={text.footer_loc}
          row2Icon={imgAPI.home_vectors[20]}
        ...
        <FooterColumn
          heading="Emails"
          row1Icon={imgAPI.home_vectors[21]}
          row1Text={text.mail_1}
          row2Icon={imgAPI.home_vectors[21]}
